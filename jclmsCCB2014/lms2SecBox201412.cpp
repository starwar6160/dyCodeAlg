...
int JCLMSCCB2014_API zwJclmsReqGenDyCode( int lmsHandle,int *dyCode )
{
	...
	jcHidRecvData(&hidHandle,resJson,ZW_JSONBUF_LEN,&rspRealLen,JCHID_RECV_TIMEOUT);
...
void myAdler32Test()
{
	...
	zwd1[36]--;
	unsigned int myAdler32=adler32(0,reinterpret_cast<char *>(zwd1),37);
}
...
//////////////////////////////////////////////////////////////////////////
	...
	for (int i=0;i<30;i++)
	{
		...
		int outLens=0;
		jcHidRecvData(&hidHandle,mData,100,&outLens,JCHID_RECV_TIMEOUT);
